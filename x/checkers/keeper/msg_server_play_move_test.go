...
import (
	...
	keepertest "github.com/amedumer/checkers/testutil/keeper"
	"github.com/amedumer/checkers/x/checkers"
	"github.com/amedumer/checkers/x/checkers/keeper"
	"github.com/amedumer/checkers/x/checkers/types"
...
func TestPlayMove(t *testing.T) {
	...
	playMoveResponse, err := msgServer.PlayMove(ctx, &types.MsgPlayMove{Creator: bob,
		GameIndex: "1",
		FromX:     1,
		FromY:     2,
		ToX:       2,
...
func TestPlayMoveNotPlayer(t *testing.T) {
	...
	playGameResponse, err := msgServer.PlayMove(context, &types.MsgPlayMove{Creator: alice, FromX: 1, FromY: 1, ToX: 1, ToY: 2, GameIndex: "1"})

	require.Nil(t, playGameResponse)
