...
import AmedumerCheckersAmedumerCheckersCheckers from './amedumer/checkers/amedumer.checkers.checkers'
...
export default { 
  AmedumerCheckersAmedumerCheckersCheckers: load(AmedumerCheckersAmedumerCheckersCheckers, 'amedumer.checkers.checkers'),
